...
(**`MCL1.DJ.featureCounts.summary`**) and a full table of counts
(**`MCL1.DJ.featureCounts`**) for each feature (gene in this case). Let take a
look at each file.
...
this is a UCSC gene id. The second to fifth columns describe the genes
