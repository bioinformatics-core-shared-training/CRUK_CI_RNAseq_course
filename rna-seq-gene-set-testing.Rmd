...
## Using the EGSEA package

Need some msigDB objects from the WEHI
```{r}
download.file("http://bioinf.wehi.edu.au/software/MSigDB/mouse_H_v5p2.rdata")
download.file("http://bioinf.wehi.edu.au/software/MSigDB/mouse_c2_v5p2.rdata")
download.file("http://bioinf.wehi.edu.au/software/MSigDB/mouse_c3_v5p2.rdata")
download.file("http://bioinf.wehi.edu.au/software/MSigDB/mouse_c4_v5p2.rdata")
download.file("http://bioinf.wehi.edu.au/software/MSigDB/mouse_c5_v5p2.rdata")
download.file("http://bioinf.wehi.edu.au/software/MSigDB/mouse_c6_v5p2.rdata")
download.file("http://bioinf.wehi.edu.au/software/MSigDB/mouse_c7_v5p2.rdata")
```


```{r}
## EGSEA (experimental) 
## Using EGSEA vignette
...
```{r echo=FALSE}
gsa = egsea(voom.results = v, contrasts = cont.matrix, gs.annots = gs.annots,
symbolsMap = v$genes, baseGSEAs = baseMethods, egsea.dir = "egsea-report",
