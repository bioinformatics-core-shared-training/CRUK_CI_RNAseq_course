...
Earlier we put all the sequencing read data (`.fastq.gz` files) in the `data` directory. Only 1000 reads are included in the files, so for convenience we then aligned using the `Rsubread` Bioconductor package. For real-world data, we would recommend using one of the aligners we learnt about yesterday.
