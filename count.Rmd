...
The raw reads, in fastq files, have been aligned using Bowtie2. The bam files containing the aligned reads can be found in the **`RNAseq/data directory`** under the **`Course_Materials`** (NB BAM file and its index are now downloadable from [Zenodo](https://zenodo.org/record/1209295#.WtB-38gh2t-) .
