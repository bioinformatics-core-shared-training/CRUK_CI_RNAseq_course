...
From the fgsea [vignette](http://www.bioconductor.org/packages/release/bioc/vignettes/fgsea/inst/doc/fgsea-tutorial.html) "fast preranked gene set enrichment analysis (GSEA)". The article describing the original software is available [here](https://www.ncbi.nlm.nih.gov/pubmed/16199517).
...
H.camera <- camera(dgeObj,index=H.ind,design=design,contrast = 2,inter.gene.cor=0.05)
...
colnames(design)
#Solution 1
myc.rst2 <- roast.DGEList(dgeObj,index=c2.ind[myc],design=design,contrast=3,nrot=999)
myc.rst2[1:15,]
