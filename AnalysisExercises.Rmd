...
* Quality control
    + Check library sizes
    + Check relative log expression plots (RLEplots)
    + Check MDSplots
...
* Try some interactive plots from Glimma or save topTable output and try Degust.
